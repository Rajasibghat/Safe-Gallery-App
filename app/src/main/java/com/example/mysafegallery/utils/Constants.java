...
public class Constants {
    ...
    public static final String PREF_THEME_KEY="themeKey";
    public static final String KEY_USER_NAME="userNameKey";
    public static final File EXPORT_IMAGE_DIRECTORY=new File(Environment.getExternalStorageDirectory().getPath()+"/Pictures/SafeGalleryImages/");
    public static final File EXPORT_VIDEO_DIRECTORY=new File(Environment.getExternalStorageDirectory().getPath()+"/Movies/SafeGalleryVideos");
